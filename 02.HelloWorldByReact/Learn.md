...
- If React loads after your file → errors will occur.
...
> Later we will use React and ReactDOM from npm packages instead of CDN to create our react-app.
...
After this chapter we will use it as another React element and Array of Elements to create complex structure in HTML.
...
> 💡 **Up next:** Now from here we will discuss the complex structure created with `createElement` and will discuss about complexity — why `createElement` alone isn't enough to keep our code clean!
